...
A guide to writing correct, performant React based on common production bugs. It
covers 12 areas, from closure mistakes to Server Component architecture.
...
2. **Check the rules**: Look up the relevant patterns in `AGENTS.md` or the specific `rules/*.md` files. Use those rules for optimization advice.
...
5. **Explain what you did**: After the code block, add an "Architectural notes" section listing the rules you applied and why.
